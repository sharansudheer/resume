...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Saran Sudheer \vspace{2pt}} & % row = 1, col = 1
  Location: Thrissur, Kerala, India \\ % row = 1, col = 2
  \href{https://www.trackdemon.in/}{\uline{www.trackdemon.in}} $|$ % row = 2, col = 1
  \href{}{\uline{LinkedIn}} $|$ % row = 2, col = 1
